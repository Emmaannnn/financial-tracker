          ...
          <div className="col-span-1 font-[Inter] p-4 rounded-lg shadow-sm bg-white" key={account.id}>
            <div className="grid grid-cols-4">
              ...
              <div className="col-span-1 flex justify-center items-center gap-2">
                <button className='p-1 text-black hover:text-blue-500 cursor-pointer'><FaRegEdit/></button>
                <button className='p-1 text-black hover:text-red-500 cursor-pointer'><RiDeleteBin6Line/></button>
              </div>
