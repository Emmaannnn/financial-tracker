...
const HistoryBills = () => {
  return (
    <div className="col-span-12 flex flex-col w-full bg-white shadow-sm rounded-lg px-4 py-3 mt-5 mb-10">
        <div className="text-md font-bold text-black/80 flex justify-between p-2">
            <h1 className="flex justify-start items-center gap-3 font-[Inter] "><PiTarget /> History</h1>
        </div>
